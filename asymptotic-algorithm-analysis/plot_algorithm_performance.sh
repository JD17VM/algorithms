...
# $1: Nombre del archivo de datos para el algoritmo 1
# $2: Nombre del algoritmo 1
# $3: Nombre del archivo de datos para el algoritmo 2 (opcional)
# $4: Nombre del algoritmo 2 (opcional)
